...
/mob/living/carbon/human/death(gibbed,deathmessage="se agarrota y se debilita...", show_dead_message = "Has muerto.")
	...
	if(wearing_rig)
		wearing_rig.notify_ai("<span class='danger'>Advertencia: user death event. Mobility control passed to integrated intelligence system.</span>")
