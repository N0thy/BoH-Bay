...
/datum/job/doctor
	...
	total_positions = 5
	spawn_positions = 3
	supervisors = "el director médico"
	...
	alt_titles = list(
		...
		"Médico de emergencias" = /decl/hierarchy/outfit/job/medical/doctor/emergency_physician,
...
/datum/job/geneticist
	...
	spawn_positions = 0
	minimal_player_age = 7
	supervisors = "el director médico y el director científico"
	selection_color = "#013d3b"
	economic_power = 7
...
/datum/job/Paramedic
	...
	alt_titles = list("Técnico Médico de Emergencias" = /decl/hierarchy/outfit/job/medical/paramedic/emt)
