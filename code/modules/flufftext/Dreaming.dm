...
var/list/dreams = list(
	...
	"una voz","un cientifico","un mono","una catastrofe","un ser querido","un harma","calor","frio","el sol",
	...
	"el oficial ingeniero en jefe","el oficial cientifico en jefe","el oficial medico en jefe",
	"una estacion ingeniera","el conserje","el tecnico de atmosfera",
	...
	"el representative", "el asesor superior", "el oficial del puente", "el ingeniero senior", "el medico", "el medico militar", "el psiquiatra",
	"el contratista medico", "el contratista de seguridad", "un polizon", "un viejo amigo", "el prospector", "el piloto", "el pasajero", "el oficial maestro de seguridad en jefe",
	"el maestro de armas", "el tecnico forense", "el oficial de bridge", "la torre", "el hombre sin cara", "un campo de flores", "una antigua casa", "el mercurio",
