/obj/item/organ/internal/brain
	...
	attack_verb = list("atacado", "abofeteado", "agotado")
	relative_size = 85
	damage_reduction = 0
...
/obj/item/organ/internal/brain/proc/handle_severe_brain_damage()
	set waitfor = FALSE
	healed_threshold = 0
	to_chat(owner, "<span class = 'notice' font size='10'><B>Donde estoy...?</B></span>")
	sleep(5 SECONDS)
	if(!owner)
		return
...
/obj/item/organ/internal/brain/proc/brain_damage_callback(var/damage) //Confuse them as a somewhat uncommon aftershock. Side note: Only here so a spawn isn't used. Also, for the sake of a unique timer.
	to_chat(owner, "<span class = 'notice' font size='10'><B>No recuerdo en que direccion se encuentra...</B></span>")
...
/obj/item/organ/internal/brain/proc/handle_damage_effects()
	...
	if(is_broken())
		if(!owner.lying)
			to_chat(owner, "<span class='danger'>Te desmayas!</span>")
		owner.Paralyse(10)
