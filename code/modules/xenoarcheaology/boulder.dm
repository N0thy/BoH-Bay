	...
	if(istype(I, /obj/item/weapon/pickaxe))
		...
		if(prob(excavation_level))
			...
			if(artifact_find)
				...
				user.visible_message("<span class='warning'>\The [src] de repente se desmorona.</span>", "<span class='notice'>\The [src] ha sido reducido bajo la cuidadosa excavaci�n, pero no habia nada de interes dentro.</span>")
			qdel(src)
